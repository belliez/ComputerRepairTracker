...
export default function MobileIntakeForm({ repairId, isOpen, onClose }: IntakeFormProps) {
  ...
  const fetchTechnicians = async () => {
    try {
      ...
      console.log("MOBILE INTAKE DEBUG: Fetching technicians with headers:", headers);
      ...
      console.log("MOBILE INTAKE DEBUG: All technicians:", data);
      
      // Filter by organization ID as a secondary precaution
      const filtered = data.filter((tech: any) => tech.organizationId === orgId);
      console.log("MOBILE INTAKE DEBUG: Filtered technicians:", filtered);
