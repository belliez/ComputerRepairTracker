...
export default function InvoiceForm({
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    try {
      ...
      console.log("INVOICE FORM DEBUG: Available currencies:", currencies);
      ...
      if (!dbCurrencyCode) {
        console.log(`INVOICE FORM DEBUG: Currency code ${values.currencyCode} not found in available currencies, will append _CORE suffix`);
        ...
        console.log(`INVOICE FORM DEBUG: Found exact match for currency code in database: ${dbCurrencyCode}`);
