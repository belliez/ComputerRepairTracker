...
export default function IntakeForm({ repairId, isOpen, onClose }: IntakeFormProps) {
  ...
  const fetchTechnicians = async () => {
    try {
      ...
      console.log("INTAKE FORM DEBUG: Fetching technicians with headers:", headers);
